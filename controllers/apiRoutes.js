...
//const mongoose = require("mongoose"); Require all models
...
module.exports = (app) => {
            ...
            $(".c-entry-box--compact__title").each(function (i, element) {
                ...
                if (result.title && result.link) {
                    ...
                    db
                        ...
                        .create(result)
                        .then((dbArticle) => {
                            // If we were able to successfully scrape and save an Article, send a message to
                            // the client
    ...
    app.get("/api/articles/:id", (req, res) => {
        ...
        db
            ...
            // ..and populate all of the notes associated with it .populate("note")
            .then((dbArticle) => {
                // If we were able to successfully find an Article with the given id, send it
                // back to the client
                res.json(dbArticle);
            })
            .catch((err) => {
    ...
    app.post("/api/articles/:id", (req, res) => {
        ...
        db
            ...
            .then((dbNote) => {
                ...
                // `req.params.id`. Update the Article to be associated with the new Note { new:
                // true } tells the query that we want it to return the updated User -- it
                // returns the original by default Since our mongoose query returns a promise,
